...
public class AllVariable : MonoBehaviour
{
    ...
    [Tooltip ("time for the vehicle to increase his speed")] [Range (0f, 1f)] public float speedAcceleration;
    [Tooltip ("time for the vehicle to decrease his speed")] [Range (1f, 10f)] public float speedDeceleration;
